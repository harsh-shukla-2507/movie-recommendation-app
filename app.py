...
def recommend(movie):
    ...
    return recommended_movies, recommended_movies_posters, recommended_movies_overview, recommended_movies_date,recommended_movies_vote, recommended_movies_genres, movie_cast
...
if st.button('Recommend'):
    ...
    names, posters ,overview,date, vote, genres, cast = recommend(selected_movie_name)
